...
You are strongly encouraged to contribute your own data sources to the project. In six easy steps:
...
# Write an ActiveRecord model(s) that defines class methods for sorting, updating, and generating columns for the data
